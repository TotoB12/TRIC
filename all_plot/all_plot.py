...
try:
    ...
    with open(os.path.join('data', folder_name, 'data.txt'), 'r') as data_file:
            for line in data_file:
                time_utc, rel_x, rel_y, d, new_x1, new_y1, new_z1, new_x2, new_y2, new_z2, new_x3, new_y3, new_z3, new_x4, new_y4, new_z4, new_x5, new_y5, new_z5, new_x6, new_y6, new_z6 = line.strip().split(',')
