...
alpha = 55.8  # The downward tilt angle of the sensor from the horizontal plane (e.g., 45 degrees)
h = 815  # Height of the sensor from the base level (ground)
beta = 0.45  # The horizontal angle between the sensor's forward direction and the measured point (left or right)
d = 958  # The distance measured by the sensor to the point
